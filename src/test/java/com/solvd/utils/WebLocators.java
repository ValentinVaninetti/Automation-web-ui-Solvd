...
public class WebLocators {
    ...
    public static final String TITLE_FIRST_POST = "/html/body/div[%s]/div/div[%s]/div[%s]/div/div/div/div[%s]/div[%s]/div[%s]/div[%s]/div[%s]/div/div/div[%s]/div[%s]/div[%s]/a/div/h3";
    public static final String SHARE_POST_BUTTON = "//div[7]/div[1]/div[1]/button";
    public static final String SHARE_TO_CHAT_BUTTON_ID = "shareToChat";
